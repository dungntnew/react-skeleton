...
This app following react [offical tutorial](https://facebook.github.io/react/docs/tutorial.html)
and Using json-server to serve dummpy api.

To start server:

```
$ json-server -p 8181 db.json
```

To start view in browser:
